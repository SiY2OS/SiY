...
import org.siy.shop.pay.fallback.WxPayApiFallback;

import java.io.File;
import java.util.Date;

@FeignClient(value = "siy-user", path = "user", fallback = WxPayApiFallback.class)
@Api(tags = "微信支付API")
public interface WxPayApi {
  ...
  @PostMapping("/createScanPayQrcodeUrlMode1")
